...
const Login = () => {
  ...
  return (
    <div className="flex h-screen w-full bg-[var(--bg)] text-[var(--text)] overflow-hidden relative">
      ...
      {/* Left Panel - Form */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 relative z-10 h-full overflow-y-auto">
        <motion.div 
          {...fadeInUp}
        ...
        >
          ...
          <div>
            <h1 className="text-2xl font-bold text-[var(--text-h)] mb-1 tracking-tight">Welcome Back</h1>
            <p className="text-[var(--text)] mb-6 text-sm leading-relaxed tracking-tight">Securely login to your dashboard to manage SaaS assets.</p>
          </div>
          ...
          <div className="bg-[var(--bg)]">
            ...
            <form onSubmit={handleLogin} className="space-y-3.5">
              <div>
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="w-full bg-[var(--bg)] border border-[var(--border)] rounded-xl py-2.5 pl-10 pr-4 text-sm text-[var(--text-h)] focus:outline-none focus:ring-2 focus:ring-[var(--accent)]/20 focus:border-[var(--accent)] transition-all placeholder:text-gray-600 shadow-sm"
                    required
                  />
                </div>
              </div>
              ...
              <button 
                type="submit"
                disabled={loading}
                className={`w-full bg-[var(--text-h)] text-[var(--bg)] py-3 rounded-xl font-bold text-sm hover:opacity-90 transition-all flex items-center justify-center gap-2 group shadow-xl mt-2 ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
              >
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-[10px] uppercase tracking-widest"><span className="bg-[var(--bg)] px-4 text-gray-500 font-bold">Or</span></div>
            </div>
          ...
          <p className="text-center mt-6 text-xs text-[var(--text)]">
            Don't have an account? {' '}
            <Link to="/signup" className="text-[var(--text-h)] font-bold hover:underline underline-offset-4 decoration-[var(--accent)] decoration-2 transition-all">Create an account</Link>
          </p>
        </motion.div>
      </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-[var(--accent-bg)] items-center justify-center p-12 overflow-hidden border-l border-[var(--border)]">
        ...
        >
          {/* Glass Card to match dashboard aesthetics */}
          <div className="w-full aspect-[4/5] max-h-[75vh] rounded-3xl overflow-hidden border border-[var(--border)] glass-effect relative shadow-2xl group flex flex-col justify-end">
            ...
            <div className="relative w-full p-8 z-20">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-[var(--text-h)] leading-tight tracking-tight mb-3">
                Decide with Precision. <br/> Scale with Confidence.
              </h2>
              <p className="text-[var(--text)] text-sm leading-relaxed max-w-sm">
                Join the network where verified metrics directly connect with strategic acquirers.
              </p>
            </div>
          </div>
        </motion.div>
